...
// Things you can do with all CollectionsTest.
import java.util.*;
...
public class CollectionMethods {
  public static void main(String[] args) {
    ...
    print("CollectionsTest.max(c) = " + Collections.max(c));
    print("CollectionsTest.min(c) = " + Collections.min(c));
...
CollectionsTest.max(c) = ten
CollectionsTest.min(c) = ALGERIA
